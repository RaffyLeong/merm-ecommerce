	...
	return (
		<div className='flex flex-col justify-center py-12 sm:px-6 lg:px-8'>
			...
			{/* Email input */}
                   ...
                   placeholder-gray-400 focus:outline-none focus:ring-cyan-500  focus:border-cyan-500 sm:text-sm'placeholder='you@example.com'/>
							</div>
						</div>
						...
						<div>
							...
							<div className='mt-1 relative rounded-md shadow-sm'>
								...
								<input id='password' type='password' required value={password} onChange={(e) => setPassword(e.target.value)}
									...
									rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-cyan-500 focus:border-cyan-500 sm:text-sm' placeholder='••••••••'/>
							</div>
						</div>
