...
const stripePromise = loadStripe(
	"pk_test_51QfLTw031jsp9nwT2asvzIBvsbdj1iyJ057aMQkyTkYURi0prpmpxjRQHNP111pJcTAXOCm4qNqM7iLuW0GWvqDO00SMM80Dp1"
);
	...
	return (
		...
		>
			...
			<div className='space-y-4'>
				...
				<motion.button
					className='flex w-full items-center justify-center rounded-lg bg-cyan-600 px-5 py-2.5 text-sm font-medium text-white hover:bg-cyan-700 focus:outline-none focus:ring-4 focus:ring-emerald-300'
