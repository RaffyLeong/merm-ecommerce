			...
			<div className='container mx-auto px-4 py-3'>
				<div className='flex flex-wrap justify-between items-center'>
					...
					<nav className='flex flex-wrap items-center gap-6'>
                        ...
                        {/* Dashboard */}
						{isAdmin && (
							<Link className='bg-cyan-700 hover:bg-cyan-600 text-white px-3 py-1 rounded-md font-medium
						...
						{user ? (
							...
							<>
								<Link to={"/signup"} className='bg-cyan-600 hover:bg-cyan-700 text-white py-2 px-4 
